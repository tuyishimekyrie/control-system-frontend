...
// import AddUsers from "../../components/SchoolComponents/AddUsers";
// import UpdateUser from "../../components/SchoolComponents/updateUser";
            ...
            <table class="min-w-[800px] w-full border-collapse table-fixed">
              <thead class="text-[15px] font-bold">
                <tr style="background-color: #1F2A45;" class="text-gray-300">
                  ...
                  <th class="border border-gray-700 p-3 text-left whitespace-nowrap max-w-[150px]">Ip Address</th>
                  <th class="border border-gray-700 p-3 text-left whitespace-nowrap max-w-[150px]">Mac Address</th>
              ...
              <tbody class="text-[14px]">
                ${currentPageUsers
                  ...
                  <td className="border border-gray-700 p-3">
                    ...
                    <td class="border border-gray-700 p-3 whitespace-nowrap">${user.ipAddress}</td>
                    <td class="border border-gray-700 p-3 whitespace-nowrap">${user.macAddress}</td>
