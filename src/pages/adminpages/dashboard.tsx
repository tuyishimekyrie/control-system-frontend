...
import DashboardLocation from "../../components/AdminComponents/DashboardLocation";
import { format, isToday, subDays, isWithinInterval } from "date-fns";
import html2canvas from "html2canvas";
import jsPDF from "jspdf";
import UserRoleChart from "../../components/AdminComponents/userCategorization";
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 col-span-3">
          <div
            ...
            style={{ backgroundColor: "#1F2A40" }}
          >
            <UserRoleChart selectedFilter={selectedFilter} />
          </div>
          <div
