...
const WebFilterRules: React.FC = () => {
  ...
  return (
    <div>
    {showModal ? (
      <div className="fixed inset-0 flex justify-center items-center" style={{ backgroundColor: "#161b2d" }}>
        <div className="absolute right-10 top-10 text-white "><button
            onClick={handleModel}
          >
      ...
      <div className="p-5 pt-0">
        ...
        <div className="flex justify-end items-center mb-6">
          <div className="text-gray-400 font-semibold mr-20">
            <span className="text-[14px]">Total Rules: {data?.length ?? 0}</span>
          </div>
        </div>
        <RuleList rules={data ?? []}/>
      </div>
